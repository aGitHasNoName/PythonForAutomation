...
def confirmOrder(a_list):
    print("The preferred order of email domains is:")
    num = 1
    for i in a_list:
        print(f"{num}\t{i}")
        num +=1
    ...
    while confirm.lower() not in ["y", "n"]:
        confirm = input("Is this correct? Enter y or n:")
...
def main():
    if confirmOrder(preferred_emails) == "y":
        print("Continuing...")
        ...
        print("You will need to change the preferred_emails list variable in the script and rerun the script. Exiting.")
